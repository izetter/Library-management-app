    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                $table .= "<tr>" . "<td>" . "<input type='number' value='$row[ISBN]'>" . "</td>" . "<td>" . "<input value='$row[title]'>" . "<td>" . "<input value='$row[publisher]'>" . "</td>" . "<td>" . "<input type='number' value='$row[year]'>" . "</td>" . "<td>" . "<input value='$row[dewey_code]'>" . "</td>" . "<td>" . "<input type='number' value='$row[current_inventory]'>" . "</td>" . "<td>" . "<input type='number' value='$row[total_inventory]'>" . "</td>" . "</tr>";
            }
            $table .= "</tbody>";
            $table .= "</table>";
            echo $table;
