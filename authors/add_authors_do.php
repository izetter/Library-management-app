...
<a href="add_authors.php">&#8592; back</a><br>
    ...
    <?php
        ...
        $sql = "INSERT INTO authors VALUE($id, '$lastName', '$firstName')";

        if (mysqli_query($conn, $sql)) {
            echo "<p>Succesfully added the following record to the <b>AUTHORS TABLE.</b></p>";
