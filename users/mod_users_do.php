...
<a href="mod_users.php">&#8592; back</a><br>
    ...
    <?php
        ...
        $sql = "UPDATE users SET email = '$email', password = '$pass', user_last_name = '$lastName', user_first_name = '$firstName', phone = '$phone', address = '$address', user_type = '$userType' WHERE user_id = $id";

        if (mysqli_query($conn, $sql)) {
            echo "<p>Record updated successfully.<p>";
            echo "<p>Updated record in the <b>USERS TABLE</b> now looks like this:</p>";
